# Contributing to node-arweave-wallet

Thank you for considering contributing to node-arweave-wallet! We welcome contributions from everyone. To ensure a smooth process, please follow the guidelines below.
...
3. **Open an issue**: Report issues on our [issue tracker](https://github.com/pawanpaudel93/node-arweave-wallet/issues).
...
- **Build**: Build the project using `tsdown`.
...
If you need assistance or have questions, feel free to reach out to us through our [issue tracker](https://github.com/pawanpaudel93/node-arweave-wallet/issues).
